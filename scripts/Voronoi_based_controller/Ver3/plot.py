...
if __name__=="__main__":
    ...
    while not rospy.is_shutdown():
        ...
        if visualizer.target_received:
            ...
            target2_pos_x.append(visualizer.targets[0][0][0])
            target2_pos_y.append(visualizer.targets[0][0][1])
            target3_pos_x.append(visualizer.targets[0][0][0])
            target3_pos_y.append(visualizer.targets[0][0][1])
            target4_pos_x.append(visualizer.targets[0][0][0])
            target4_pos_y.append(visualizer.targets[0][0][1])
        
    pygame.quit()   
    plt_dict = {'frame_id'              : frame,
                "target1_pos_x"                 : target1_pos_x,
                "target1_pos_y"                 : target1_pos_y,
                "target2_pos_x"                 : target2_pos_x,
                "target2_pos_y"                 : target2_pos_y,
                "target3_pos_x"                 : target3_pos_x,
                "target3_pos_y"                 : target3_pos_y,
