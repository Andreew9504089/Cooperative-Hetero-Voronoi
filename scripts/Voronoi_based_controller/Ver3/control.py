...
class PTZCamera():
    def __init__(self, map_size, grid_size, general_properties,
                 ...
                 manipulator_properties=None, smoke_detector_properties=None, K_p=0.5, K_v=1, step = 0.1):
...
if __name__ == "__main__":
    ...
    save_path = "/home/andrew/research_ws/src/voronoi_cbsa/result/" + str(trial_id) + suffix
